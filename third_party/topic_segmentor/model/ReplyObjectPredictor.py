...
from third_party.topic_segmentor.grammar.SentenceGrammarAnalyzer import (
    SentenceGrammarAnalyzer,
)


class ReplyObjectPredictor:
    def __init__(
        self, window, cosineSimilarityThreshold, similar_topic_calculator, tokenizer
    ):
        self.window = window
