...
class Model:
    def __init__(self, messages, tokenizer):
        ...
        self.index2wordSet = set(self.innerModel.wv.index_to_key)
    ...
    def __getitem__(self, index):
        return self.innerModel.wv.get_vector(index)
    ...
    def calculateSimilarity(self, messageA, messageB, indexDistance):
        ...
        while startA < len(fullTokensA):
            ...
            while startB < len(fullTokensB):
                ...
                cosine = self.innerModel.wv.n_similarity(tokensA, tokensB) * decay
